...
Com o Docker, você pode executar a aplicação em um ambiente containerizado sem precisar instalar o Python ou as dependências diretamente na sua máquina.
